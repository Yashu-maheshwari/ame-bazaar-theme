...
function ame_bazaar_handle_dynamic_text_files() {
	...
	// sitemap.xml interception removed to allow native WP sitemap generation
	erations and Admin Custom Fields Management.
 *
 * @package Ame_Bazaar
 */
